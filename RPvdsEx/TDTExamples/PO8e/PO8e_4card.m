classdef PO8e_4card
    ...
    methods
        function obj = PO8e_4card()
            ...
            %[notfound,warnings] = loadlibrary([lib ext], 'PO8e.h');
            loadlibrary([lib ext], 'PO8e.h');
        ...
        function obj = readBlock(obj, index, nSamples)
            ...
            obj.Status(index) = calllib(obj.LibName, 'readBlock', obj.CardPointer{index}, pBuffer, nSamples);
